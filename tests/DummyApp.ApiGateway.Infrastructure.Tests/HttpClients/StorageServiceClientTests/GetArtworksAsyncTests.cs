...
public class GetArtworksAsyncTests : StorageServiceClientTestsBase
{
    ...
    [Fact]
    public async Task GetArtworksAsync_ReturnsArtworkList_WhenCreatorIdProvided()
    {
        var artworks = new[]
        {
            new ArtworkDto
    ...
    [Fact]
    public async Task GetArtworksAsync_ReturnsNull_WhenResponseIsNotSuccessful_WithCreatorId()
    {
        using var httpClient = CreateHttpClient(new HttpResponseMessage(HttpStatusCode.InternalServerError));
        var client = new StorageServiceClient(httpClient, LoggerMock.Object);
    ...
    [Fact]
    public async Task GetArtworksAsync_ReturnsNull_WhenResponseContentIsNull_WithCreatorId()
    {
        var response = new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = JsonContent.Create<IEnumerable<ArtworkDto>>(null)
    ...
    [Fact]
    public async Task GetArtworksAsync_ReturnsNull_WhenResponseIsInvalidJson_WithCreatorId()
    {
        var response = new HttpResponseMessage(HttpStatusCode.OK)
        {
            Content = new StringContent("not-json", Encoding.UTF8, "application/json")
    ...
    [Fact]
    public async Task GetArtworksAsync_TreatsWhitespaceCreatorIdAsNoFilter()
    {
        var artworks = new[]
        {
            new ArtworkDto
