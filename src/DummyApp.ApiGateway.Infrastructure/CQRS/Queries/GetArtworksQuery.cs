...
public sealed record GetArtworksPageQuery(string? CreatorId = null, bool IsActive = true, int PageNumber = 1, int PageSize = 10) : IRequest<PaginatedResult<ArtworkDto>>;
